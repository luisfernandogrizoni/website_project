...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // --------------------------------------
    // Inicialização das mascaras de documento
    mascaras.initMasks();
    ...
    // --------------------------------------
    // 3. Regras de Interface (Estado Civil)
    // --------------------------------------
    ...
    /**
     * Exibe ou oculta o campo de cônjuge baseado no estado civil selecionado.
     * Adiciona/remove a obrigatoriedade (required) do input dinamicamente.
     */
